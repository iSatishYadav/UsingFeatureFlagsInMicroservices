...
````
> By default `AddFeatureManagement` from `Microsoft.FeatureManagement.AspNetCore` looks for key named `FeatureManagement`, we've used an overload to specify a custom root for our Feature Management configuration.
